...
src/prngs/chacha.o src/prngs/fortuna.o src/prngs/rc4.o src/prngs/rng_get_bytes.o \
src/prngs/rng_make_prng.o src/prngs/sober128.o src/prngs/sprng.o src/prngs/yarrow.o \
src/stream/chacha/chacha_crypt.o src/stream/chacha/chacha_ivctr32.o src/stream/chacha/chacha_ivctr64.o \
